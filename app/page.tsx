          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Visualize estatísticas detalhadas sobre suas candidaturas e
                    identifique padrões.
                  </CardDescription>
                </CardContent>
              </Card>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 items-center">
              <Card>
                ...
                <CardContent>
                  <p className="text-lg">
                    CandidaturasAnalytics é uma ferramenta open source projetada
                    para ajudar candidatos a empregos a entenderem melhor seus
                    processos seletivos. Ao analisar suas candidaturas passadas,
                    nossa plataforma oferece insights valiosos que podem
                    aumentar significativamente suas chances de sucesso.
                  </p>
                  <p className="mt-4 text-lg">
                    Com recursos de análise de dados e visualizações intuitivas,
                    você pode identificar áreas de melhoria, entender onde estão
                    os gargalos em seus processos seletivos e receber
                    recomendações personalizadas para aprimorar suas
                ...
                <CardContent>
                  ...
                  <div className="mt-6">
                    <Button asChild>
                      ...
                      >
                        <Github className="mr-2 h-4 w-4" /> Visite nosso GitHub
                      </Link>
                    </Button>
                  </div>
                </CardContent>
